 ...
 * @author karem
 */
public class client1_jframe extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(client1_jframe.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
    ...
    public static void main(String args[]) throws IOException{
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(client1_jframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new client1_jframe().setVisible(true);
            }
        });
         ...
         //then a string is used to hold the data entered from the uesr to read it as a line
          ...
          String fromServer="";
            ...
            if("Login client1".equals(fromServer)){
                 client11_func newframe = new client11_func();
